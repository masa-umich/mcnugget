...
def NBP():
    ...
    vol = RP.REFPROPdll("Nitrogen","PT","V",MASS_BASE_SI,0,0,p1,T1,[1.0]).Output[0]
    energy = RP.REFPROPdll("Nitrogen","PT","E",MASS_BASE_SI,0,0,p1,T1,[1.0]).Output[0]
    print("--- Initial State ---")
    ...
    p2 = RP.REFPROPdll("Nitrogen","ED","P",MASS_BASE_SI,0,0,energy2,(1/new_vol),[1.0]).Output[0]
    T2 = RP.REFPROPdll("Nitrogen","ED","T",MASS_BASE_SI,0,0,energy2,(1/new_vol),[1.0]).Output[0]
