#flow fuel after, but want to flow as close as possible to oxygen 
#close after as possible, do not want to risk before or boom 
#limited number of times that could be tested 
#time change is priming time,
#fuel side have two runs, 95% confidence interval 
