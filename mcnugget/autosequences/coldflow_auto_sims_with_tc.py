...
vent_state_channels = [FUEL_VENT_IN, PRESS_VENT_IN, OX_LOW_VENT_IN, 
...
state_channels = [FUEL_VENT_IN, FUEL_PREVALVE_IN, FUEL_FEEDLINE_PURGE_IN,
...
# Thermocouples
PRESS_TANK_TC_1 = "gse_ai_74"
PRESS_TANK_TC_2 = "gse_ai_75"
PRESS_TANK_TC_3 = "gse_ai_76"

TCs = [PRESS_TANK_TC_1, PRESS_TANK_TC_2, PRESS_TANK_TC_3]

# Parameters for testing
INITIAL_FUEL_TANK_PRESSURE = 0
INITIAL_OX_TANK_PRESSURE = 0
INITIAL_PRESS_TANK_PRESSURE = 0
INITIAL_PRESS_TANK_TEMP = 20
INITIAL_2K_PRESSURE = 2000
PRESS_TANK_TARGET_PRESSURE = 3800
...
DAQ_STATE.update({
    ...
    PRESS_TANK_TC_1: INITIAL_PRESS_TANK_TEMP,
    PRESS_TANK_TC_2: INITIAL_PRESS_TANK_TEMP,
    PRESS_TANK_TC_3: INITIAL_PRESS_TANK_TEMP
})
...
WRITE_CHANNELS = state_channels + PTs + TCs + [DAQ_TIME] # added TCs
    ...
    with client.open_writer(
        ...
        while True:
            try:
                ...
                ox_leak_rate = (2 * math.sqrt(true_ox_pressure)) / math.sqrt(PRESS_TANK_TARGET_PRESSURE) * rate
                press_leak_rate = (2 * math.sqrt(true_press_pressure)) / math.sqrt(PRESS_TANK_TARGET_PRESSURE) * rate
